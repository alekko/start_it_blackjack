class Game {/**Evil comments with my freaky peasant language skills*/
    constructor() { 
      this.gameRound = this.gameRound /**This is like a status, how many times has been played, gamerond act as iterator */
    }
